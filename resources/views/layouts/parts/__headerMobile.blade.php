<header class="header header--mobile" data-sticky="true">
    <div class="header__top">
        ...
        <div class="header__right">
            <ul class="navigation__extra">
                ...
                <li>
                    <div class="ps-dropdown language"><a href="#"><img src="assets/img/flag/en.png" alt="">English</a>
                        <ul class="ps-dropdown-menu">
    ...
    <div class="navigation--mobile">
        <div class="navigation__left"><a class="ps-logo" href="index.html"><img src="assets/img/logo_light.png" alt=""></a></div>
